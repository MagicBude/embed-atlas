...
> 当前状态：项目处于 `Phase 1：最小可用网站`，首批 10 篇知识文章和 3 个经过测试的在线工具已经公开部署，文章继续等待独立同行审阅。实时进展见 [`PROJECT_STATUS.md`](PROJECT_STATUS.md)。
...
| 在线工具箱 | 进制、位运算、HEX/ASCII、CRC、大小端、UART 等 | 首批 3 个可使用 |
